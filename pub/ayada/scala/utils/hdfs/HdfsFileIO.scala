package pub.ayada.scala.utils.hdfs
...
object HdfsFileIO {
    ...
    def getProps(HDPClientConf: Configuration, inFilePath: String): Properties = {
        val props = new Properties
        props.load(getHdfsFlInputStream(HDPClientConf, inFilePath))
        props
    }
    def getProps(inFilePath: String): Properties = {
        val props = new Properties
        props.load(getHdfsFlInputStream(inFilePath))
        props
    }
